# Gemini Instructions: TechnologyMonastery.org

Hey Gemini! Welcome to TechnologyMonastery.org.

**Project:** TechnologyMonastery.org -- a Free For Charity nonprofit website
...
The site deploys to `https://freeforcharity.github.io/TechnologyMonastery.org/` (and your custom domain if configured). The `assetPath()` function from `src/lib/assetPath.ts` handles this automatically.
