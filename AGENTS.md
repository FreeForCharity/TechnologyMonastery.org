# AI Agent Instructions: TechnologyMonastery.org
...
These sites deploy to `https://freeforcharity.github.io/TechnologyMonastery.org/` and optionally to a custom domain if one is configured for this repo.
